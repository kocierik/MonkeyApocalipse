CC = g++
CFLAGS = -c -Wall
OBJECTS = main.o engineGame.o character.o drawWindow.o player.o enemy.o
LIBRARY = -lncurses
...
main.o: main.cpp models/engineGame.hpp models/character.hpp models/drawWindow.hpp models/player.hpp models/enemy.hpp
	$(CC) $(CFLAGS) main.cpp
