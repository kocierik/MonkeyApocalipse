...
void DrawWindow::drawMenu(){
    ...
    mvprintw(1,0,"                                                                                                            ");
    mvprintw(2,0,"    b    d  P*Y  8b 8 8  d 88888 Yb  dP        A   8**Y  P*Y   P**b8   b    8     Yb  dP 8**Y .P*Y8 88888   ");
    mvprintw(3,0,"    8b  d8 P   Y 8Yb8 8od  8__    YbdP        PY   8__P P   Y P   `*   PY   8      YbdP  8__P `Yo.* 8__     ");
    mvprintw(4,0,"    8Yb P8 b   d 8 Y8 8*Y  8**     8P        P__Y  8**  b   P Y       P__Y  8  .o   8P   8**  o.`Y8 8**     ");
    mvprintw(5,0,"    8 Y  8  Ybo  8  Y 8  Y 88888  dP        P****Y 8     P*Y   YoodP P****Y 8ood8  dP    8     8oP* 88888   ");
    mvprintw(6,0,"                                                                                                            ");
    mvprintw(7,0,"     THE REVENGE OF THE MONKEYS HAS JUST BEGUN!                                                             ");
    mvprintw(8,0,"                                                                                                            ");
    attroff(COLOR_PAIR(1)); //CHIUSURA DEL COLORE ROSSO E NERO
}

void DrawWindow::printCommand(int* cnt){
    if(*cnt == 0) mvprintw(12,5,"==>  (X) START THE FIGHT!"); else mvprintw(12,5,"     START THE FIGHT!    ");
    if(*cnt == 1) mvprintw(14,5,"==>  (X) HOW TO PLAY"); else mvprintw(14,5,"     HOW TO PLAY    ");
    if(*cnt == 2) mvprintw(16,5,"==>  (X) CREDITS"); else mvprintw(16,5,"     CREDITS      ");        // MUOVO CON LE FRECCE
    if(*cnt == 3) mvprintw(18,5,"==>  (X) QUIT"); else mvprintw(18,5,"     QUIT     ");
...
void DrawWindow::printCredits(){
    ...
    attron(COLOR_PAIR(2));
    mvprintw(10,3,"                                                                                                       ");
    mvprintw(11,3,"        ____ ____ _ _  _              ____ _  _ ____                 ___  ____ ___  ___  ____          ");
    mvprintw(12,3,"        |___ |__/ | |_/               |___ |\\/| |__|                 |__] |___ |__] |__] |___          ");
    mvprintw(13,3,"        |___ |  \\ | | \\_              |___ |  | |  |                 |__] |___ |    |    |___          ");
    mvprintw(14,3,"                                                                                                       ");
    mvprintw(15,3,"                                                                                                       ");
